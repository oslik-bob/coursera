...
class GameSurface(ScreenHandle):
    ...
    def draw_hero(self):
        self.game_enginene.hero.draw(self)
...
# FIXME
    def draw(self, canvas):
        ...
        her_hp = self.engine.hero.hp / self.engine.hero.max_hp
        her_exp = self.engine.hero.exp / (100 * (
        ...
        pygame.draw.rect(self,
                         colors["green"],
                         (50, 70, 200 * her_exp, 30))

        font = pygame.font.SysFont("comicsansms", 20)
        
        self.blit(
            font.render(
                f'Hero at {self.engine.hero.position}',
                True,
                colors["black"]),
            (250, 0))
        ...
        self.blit(
            font.render(f'HP', True, colors["black"]),
            (10, 30))
        
        self.blit(
            font.render(f'Exp', True, colors["black"]),
            (10, 70))

        self.blit(
            font.render(f'{her_hp}', True, colors["black"]),
            (60, 30))
        
        self.blit(
            font.render(f'{her_exp}', True, colors["black"]),
            (60, 70))

        self.blit(
            font.render(f'Level', True, colors["black"]),
            (300, 30))
        
        self.blit(
            font.render(f'Gold', True, colors["black"]),
            (300, 70))
        ...
        self.blit(
            font.render(f'Str', True, colors["black"]),
            (420, 30))
        
        self.blit(
            font.render(f'Luck', True, colors["black"]),
            (420, 70))

        self.blit(
            font.render(
                f'{self.engine.hero.stats["strength"]}',
                True,
                colors["black"]),
            (480, 30))
