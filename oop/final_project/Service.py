    ...
    class Map:
        def __init__(self):
            self.Map = [f'{"0"*43}',
                      ...
                      f'0{" "*12}0       0       0{" "*12}0',
                    # f'0{" "*11}0                 0{" "*11}0',
                     f'0{" "*11}0      00 00      0{" "*11}0',
                     f'0{" "*11}0      00 00      0{" "*11}0',
                   # f'0{" "*10}00                 00{" "*10}0',
                    f'0{" "*11}00       0       00{" "*11}0',
                    f'0{" "*9}00  0     0 0     0  00{" "*9}0',
                    f'0{" "*9}0 0   000     000   0 0{" "*9}0',
                    f'0{" "*9}0  0               0  0{" "*9}0',
                    f'0{" "*9}0   0             0   0{" "*9}0',
                   # f'0{" "*9}0    00         00    0{" "*9}0',
                    f'0{" "*9}0      0000 0000      0{" "*9}0',
                   f'0{" "*8}0                       0{" "*8}0',
                  f'0{" "*7}0     0    0   0    0     0{" "*7}0',
                  f'0{" "*7}0000000    00000    0000000{" "*7}0',
                       f'0{" "*13} 0000     0000{" "*14}0',                   
                                 f'0{" "*41}0',
                                 f'{"0"*43}',
                        ]
            self.Map = list(map(list, self.Map))
...
def service_init(sprite_size, full=True):
    ...
    wall[0] = create_sprite(
        os.path.join("texture", "wall.png"),
        sprite_size)
    
    floor1[0] = create_sprite(
        os.path.join("texture", "Ground_1.png"),
        sprite_size)
    
    floor2[0] = create_sprite(
        os.path.join("texture", "Ground_2.png"),
        sprite_size)
    
    floor3[0] = create_sprite(
        os.path.join("texture", "Ground_3.png"),
        sprite_size)

    file = open("objects.yml", "r")

    object_list_tmp = yaml.load(file.read(), Loader=yaml.BaseLoader)
    ...
    if full:
        file = open("levels.yml", "r")
        level_list = yaml.load(file.read(),Loader=yaml.BaseLoader)['levels']
        print(level_list)
        level_list.append({'map': EndMap.Map(), 'obj': EndMap.Objects()})
        print(level_list)
        file.close()
